...
const Search_product_by_category = () => {
const [products, setproducts] = useState([]);

let paramsId =useParams()
useEffect(() => {
 fetch(`https://dummyjson.com/products/category/${paramsId.cname}`)
.then(res => res.json())
          ...
          {products.map((k)=>(
            ...
            <div className="product-item bg-light mb-4">
              <div className="product-img position-relative overflow-hidden">
                <img className="img-fluid w-100" src={k.thumbnail} alt />
...
export default Search_product_by_category